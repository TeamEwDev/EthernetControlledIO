...
static CU_pSuite create_suite(const char *strName, CU_InitializeFunc pInit, CU_CleanupFunc pClean, CU_SetUpFunc pSetup,
...
/*------------------------------------------------------------------------*/
CU_pSuite CU_add_suite_with_setup_and_teardown(const char *strName, CU_InitializeFunc pInit, CU_CleanupFunc pClean,
        CU_SetUpFunc pSetup, CU_TearDownFunc pTear)
{
...
CU_ErrorCode CU_register_nsuites(int suite_count, ...)
{
    ...
    for (i = 0 ; i < suite_count ; ++i)
    {
        ...
        if (NULL != pSuiteItem)
        {
            ...
            {
                if (NULL != (pSuite = CU_add_suite_with_setup_and_teardown(pSuiteItem->pName, pSuiteItem->pInitFunc,
                                      pSuiteItem->pCleanupFunc, pSuiteItem->pSetUpFunc, pSuiteItem->pTearDownFunc)))
                {
