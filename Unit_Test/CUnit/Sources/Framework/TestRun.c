...
#define HAL_CLOCKS_PER_SEC 1000
/*=================================================================
...
double CU_get_elapsed_time(void)
{
    ...
    {
        return ((double)HAL_GetTick() - (double)f_start_time) / (double)HAL_CLOCKS_PER_SEC;
    }
    else
    {
...
CU_ErrorCode CU_run_all_tests(void)
{
    ...
    else
    {
        ...
        f_run_summary.ElapsedTime = ((double)HAL_GetTick() - (double)f_start_time) / (double)HAL_CLOCKS_PER_SEC;
...
static void test_succeed_if_setup(void)
{
    CU_TEST(SetUp_Passed);
}
static void test_fail_if_not_setup(void)
{
    CU_TEST(SetUp_Passed);
}
...
{
    SetUp_Passed = CU_TRUE;
}
static void suite_teardown(void)
{
    SetUp_Passed = CU_FALSE;
}
